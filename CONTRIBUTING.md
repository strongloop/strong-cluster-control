...
Thank you for your interest in `strong-cluster-control`, an open source project
administered by StrongLoop.

Contributing to `strong-cluster-control` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-cluster-control)
